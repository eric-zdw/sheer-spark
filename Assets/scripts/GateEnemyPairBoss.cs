...
public class GateEnemyPairBoss : MonoBehaviour {
	...
	void Start () {
		...
		Vector3 enemyPos3 = enemy3.transform.position;
		Vector3 enemyPos4 = enemy4.transform.position;
		Vector3 enemyPos5 = enemy5.transform.position;
